...
float4 PS( VS_OUTPUT input ) : SV_Target
{
  ...
  noiseT = Snoise3D ( noiseIn);
  float4 bitchSignal0000 = lerp( float4(0.00000f, 0.00000f, 0.00000f, 1.00000f), float4(1.00000f, 1.00000f, 1.00000f, 1.00000f), noiseT );


//RGBA CHANNEL
  float4 Layer00 = bitchSignal0000;
...
//FINAL PIXEL
  ...
  float4 diffuseColour = bitchSignal0000;
