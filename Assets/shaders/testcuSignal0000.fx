...
float4 PS( VS_OUTPUT input ) : SV_Target
{
  ...
  float4 Signal33 = lerp( float4(0.29412f, 0.36471f, 0.34902f, 1.00000f), float4(1.00000f, 1.00000f, 1.00000f, 1.00000f), noiseT );
...
//RGBA CHANNEL
  float4 Layer00 = testcuSignal0000;
  float4 Layer33 = testcuSignal2222;
  float4 Layer22 = float4( 1, 1, 1, 1 ) - ( float4( 1, 1, 1, 1 ) - 0.5*testcuSignal0000 )* ( float4( 1, 1, 1, 1 ) - 0.5*testcuSignal2222);
...
//FINAL PIXEL
  ...
  float4 diffuseColour = testcuSignal0000;
