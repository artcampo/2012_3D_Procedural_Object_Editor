...
float4 PS( VS_OUTPUT input ) : SV_Target
{
  ...
  noiseT = Snoise3D ( noiseIn);
  float4 ghuSignal2222 = lerp( float4(0.00000f, 0.00000f, 0.00000f, 1.00000f), float4(1.00000f, 0.56471f, 0.88627f, 1.00000f), noiseT );
  ...
  float4 ghuSignal0000 = lerp( float4(0.00000f, 0.00000f, 0.00000f, 1.00000f), float4(0.46667f, 0.63529f, 1.00000f, 1.00000f), noiseT );


//RGBA CHANNEL
  float4 Layer00 = ghuSignal0000;
  float4 Layer33 = ghuSignal2222;
  float4 Layer22 = 0.3675*ghuSignal0000 + 0.6325*ghuSignal2222;
...
//FINAL PIXEL
  ...
  float4 diffuseColour = ghuSignal0000;
  finalPixel.rgb = Layer00;
