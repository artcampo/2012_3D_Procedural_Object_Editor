...
GizmoTMeshModel* GizmoT::convert( ID3D10Device* aDev, ColourMapping* aColours )
{
...
D3DXVECTOR3 GizmoT::highlightedAxisU()
{
  return mBase[mHighlightedAxisU];
}

D3DXVECTOR3 GizmoT::highlightedAxisV()
{
  return mBase[mHighlightedAxisV];
}

bool GizmoT::check(D3DXVECTOR3 aRayB, D3DXVECTOR3 aRayE, float aDistThreshold)
{
  mHasHighlight = false;
...
bool GizmoT::hasHighlight()
{
  return mHasHighlight;
}

//  \return increment with respect to center of mass
D3DXVECTOR3 GizmoT::newPosition(D3DXVECTOR3 aRayB, D3DXVECTOR3 aRayE, D3DXVECTOR3 aCamU, D3DXVECTOR3 aCamV)
{
  D3DXVECTOR3 pos;
...
gizmoTLine GizmoT::composedAxis(int i)
{
  gizmoTLine line;
