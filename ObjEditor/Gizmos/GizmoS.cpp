...
GizmoTMeshModel* GizmoS::convert( ID3D10Device* aDev, ColourMapping* aColours )
{
...
D3DXVECTOR3 GizmoS::highlightedAxisU()
{
  return mBase[mHighlightedAxisU];
}

D3DXVECTOR3 GizmoS::highlightedAxisV()
{
  return mBase[mHighlightedAxisV];
}

bool GizmoS::check(D3DXVECTOR3 aRayB, D3DXVECTOR3 aRayE, float aDistThreshold)
{
  mHasHighlight = false;
...
bool GizmoS::hasHighlight()
{
  return mHasHighlight;
}

//  \return increment with respect to center of mass
D3DXVECTOR3 GizmoS::newPosition(D3DXVECTOR3 aRayB, D3DXVECTOR3 aRayE, D3DXVECTOR3 aCamU, D3DXVECTOR3 aCamV)
{
  D3DXVECTOR3 pos;
...
gizmoTLine GizmoS::composedAxis(int i)
{
  gizmoTLine line;
